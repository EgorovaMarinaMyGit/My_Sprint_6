...
class OrderPageLocators:
    ...
    #LOGO_DZEN = (By.XPATH, "//path[@d='M24.667 13.788a.203.203 0 0 0-.193-.2c-3.827-.145-6.157-.633-7.786-2.262-1.633-1.633-2.12-3.964-2.265-7.8a.2.2 0 0 0-.2-.193h-.446a.203.203 0 0 0-.2.193c-.145 3.834-.632 6.167-2.265 7.8-1.631 1.63-3.959 2.117-7.786 2.262a.2.2 0 0 0-.193.2v.447c0 .107.086.195.193.2 3.827.145 6.157.633 7.786 2.263 1.63 1.63 2.116 3.954 2.263 7.775a.2.2 0 0 0 .2.193h.448a.203.203 0 0 0 .2-.194c.147-3.82.633-6.145 2.263-7.774 1.631-1.632 3.96-2.118 7.787-2.263a.2.2 0 0 0 .193-.2v-.447z']") # лого Дзена (звёздочка)
